...
static const float WATER_COLOR_LIGHTNESS = 0.22;
...
static const float3 FOG_COLOR 					= float3( 0.22, 0.22, 0.24 );
static const float 	FOG_BEGIN					= 1.0f;
static const float 	FOG_END 					= 150.0f;
static const float 	FOG_MAX 					= 0.34f; 
...
static const float  SHADOW_WEIGHT_TERRAIN    	= 0.4f;
static const float  SHADOW_WEIGHT_MAP    		= 0.55f;
